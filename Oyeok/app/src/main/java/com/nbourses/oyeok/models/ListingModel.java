...
public class ListingModel {
    ...
    public ListingModel(String listing_id, String name, String config, int listed_ll_pm, int listed_or_psf, String lat, String lng, int real_ll_pm, int real_or_psf, String possession_date, String req_avl, String locality, String city, String rate_growth, String portals, String listings, String transactions, boolean checkbox) {
