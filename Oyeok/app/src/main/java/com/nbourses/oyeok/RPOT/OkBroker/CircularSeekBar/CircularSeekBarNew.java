...
//            canvas.drawText("Max:"+maxvalue,mCircleRectF.right-60*DPTOPX_SCALE,mCircleRectF.top+mCircleRectF.height()/2,mCircleTextColor);
        ...
        //start.draw(canvas);
        canvas.drawText("min:"+minValue,mCircleRectF.left+10*DPTOPX_SCALE,mCircleRectF.top+mCircleRectF.height(),mCircleRangeColor);
        canvas.drawText("max:" + maxvalue + ",00,000", mCircleRectF.right - 40 * DPTOPX_SCALE, mCircleRectF.top + mCircleRectF.height(), mCircleRangeColor);
