...
public class ListingExplorerAdapter extends BaseAdapter {

    private ArrayList<portListingModel> portListing;
    private Context context;
    portListingModel listing;
    private LayoutInflater inflater;
    public ListingExplorerAdapter(Context context, ArrayList<portListingModel> portListing) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            holder = (ListingExplorerAdapter.Holder) v.getTag();
        }
...
//            text="<html><sup></html>";
    ...
    public void setIcon(portListingModel item, ListingExplorerAdapter.Holder holder) {
