...
public class marker_pricebar extends View {
    ...
    public marker_pricebar(Context context) {
        this(context, null, 0);
    }

    public marker_pricebar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public marker_pricebar(Context context, AttributeSet attrs, int defStyle) {
