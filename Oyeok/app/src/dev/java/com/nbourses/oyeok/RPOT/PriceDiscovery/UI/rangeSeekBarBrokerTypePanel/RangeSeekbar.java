...
/*            Drawable d = getResources().getDrawable(R.drawable.seekbar_notselectedround);
            d.setBounds(0 , 0, 20, 20);
            d.draw(canvas);*/
            Paint p = new Paint();
            p.setColor(Color.parseColor("#CCCCCC"));

            canvas.drawCircle(textDrawLeft + 40,  mSeekbarRect.bottom - 7, 20 ,  p);
