 ...
 */
package com.nbourses.oyeok.RPOT.PriceDiscovery.UI.rangeSeekBarBrokerTypePanel;
...
public class RangeSeekbar_roomprice extends View {
    ...
    public RangeSeekbar_roomprice(Context context) {
        this(context, null, 0);
    }

    public RangeSeekbar_roomprice(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RangeSeekbar_roomprice(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void applyConfig(Context context, AttributeSet attrs) {
        ...
        mSeekbarHeight = (int) a.getDimension(
                R.styleable.RangeSeekbar_seekbarHeight, 3);
        mTextSize = (int) a.getDimension(R.styleable.RangeSeekbar_textSize, 12);
        mMarginBetween = (int) a.getDimension(
                R.styleable.RangeSeekbar_spaceBetween, 26);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            final String text2draw_down = mTextArray[i].toString();
            ...
            canvas.drawText(text2draw_down, textDrawLeft, mPaddingRect.top + 116
                    + mTextSize, mPaint);
