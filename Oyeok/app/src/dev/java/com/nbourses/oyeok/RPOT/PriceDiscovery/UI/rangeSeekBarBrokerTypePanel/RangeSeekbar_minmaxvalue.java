...
public class RangeSeekbar_minmaxvalue extends View {
    ...
    public RangeSeekbar_minmaxvalue(Context context) {
        this(context, null, 0);
    }

    public RangeSeekbar_minmaxvalue(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RangeSeekbar_minmaxvalue(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void applyConfig(Context context, AttributeSet attrs) {
        ...
        mTextSize = (int) a.getDimension(R.styleable.RangeSeekbar_textSize, 10);
        mMarginBetween = (int) a.getDimension(
                R.styleable.RangeSeekbar_spaceBetween, 20);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            final String min_max = mTextArray[i].toString();
            ...
            canvas.drawText(min_max, textDrawLeft, mPaddingRect.top + 116
                    + mTextSize, mPaint);
