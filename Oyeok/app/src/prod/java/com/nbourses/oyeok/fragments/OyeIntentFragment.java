...
public class OyeIntentFragment extends Fragment implements MyFragment.OnFragmentInteractionListener {

    public static final String TAG = "OyeIntentFragment";
...
//    private TextView pricevalue;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       /* if(b.getStringArray("propertySpecification")!=null)
        {
            propertySpecification=b.getStringArray("propertySpecification");my_test_layout.i("new","came from signup");
            letsOye();
        }*/
        ...
        inputSearch.setText(bundle.getString("Address"));
...
//        pricevalue = (TextView) rootView.findViewById(R.id.textSelected);
        ...
        fragOne.setmListener((MyFragment.OnFragmentInteractionListener) OyeIntentFragment.this);
...
//        ((MainActivity)getActivity()).changeDrawerToggle(false,"OyeABroker");
        ...
        shopImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FragmentTransaction ft = fm.beginTransaction();
                MyFragment fragOne = new MyFragment();
                fragOne.setmListener(OyeIntentFragment.this);
                fm.beginTransaction();
                //Fragment fragOne = new MyFragment();
                Bundle arguments = new Bundle();
        ...
        mOye.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(temp.length<=1)
                    ((ClientMainActivity)getActivity()).showToastMessage("Please enter all the fields");
                else
                    letsOye();
            }
        });
    ...
    public void letsOye(){
        ...
        if(dbHelper.getValue(DatabaseConstants.userId).equals("null"))
        {
            ...
            fragmentTransaction.replace(R.id.container_oye, fragment);
...
//                                        ((MainActivity)getActivity()).showToastMessage("Oye published.Sit back and relax while we find a broker for you");
                                        ...
                                        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                                        f.setArguments(b);
                                        fragmentTransaction.replace(R.id.container_oye, f);
                                        fragmentTransaction.commit();
